...
const facilities: Facility[] = [
  ...
  },
  {
    ...
    description:
      "採用目的のIT企業にとって理想的なリフレッシュとインスピレーションを提供するための、特別なワーケーションパッケージです。採用を支援するために、レンタルオフィス、ホテル、特産品、大学の来校などを含んでいます。",
  },
  {
    id: 3,
    imageUrl: "/package2.jpg",
    ...
    description:
      "それ以外の目的の方にとって理想的なリフレッシュとインスピレーションを提供するための、特別なワーケーションパッケージです。イノベーションとビジネスの発展を支援するために、レンタルオフィス、ホテル、特産品、観光などを含んでいます。",
  },
];
