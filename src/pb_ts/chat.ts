...
/**
 * @generated ServiceType for protobuf service chat.OpenAIService
 */
export const OpenAIService = new ServiceType("chat.OpenAIService", [
    { name: "StreamChat", serverStreaming: true, options: {}, I: ChatRequest, O: ChatResponse }
]);
